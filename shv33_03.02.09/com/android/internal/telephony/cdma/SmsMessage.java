...
public class SmsMessage extends SmsMessageBase {
    ...
    private void parsePdu(byte[] pdu) {
        ...
        try {
            ...
            parseSms();
            if (OUTPUT_DEBUG_LOG) {
                Rlog.d(LOG_TAG, "PDU data : " + this.mBearerData.toString());
            }
    ...
    public void parseSms() {
        ...
        if (this.mMessageBody != null) {
            if (OUTPUT_DEBUG_LOG) {
                Rlog.v(LOG_TAG, "SMS message body: '" + this.mMessageBody + "'");
            }
        } else if (this.mUserData != null && OUTPUT_DEBUG_LOG) {
            Rlog.v(LOG_TAG, "SMS payload: '" + IccUtils.bytesToHexString(this.mUserData) + "'");
        }
    }
    ...
    static boolean isAscii7bitSupportedForLongMessage() {
        PersistableBundle pb = ((CarrierConfigManager) PhoneFactory.getDefaultPhone().getContext().getSystemService("carrier_config")).getConfig();
        if (pb != null) {
