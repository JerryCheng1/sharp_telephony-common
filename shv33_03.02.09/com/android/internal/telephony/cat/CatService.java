...
public class CatService extends Handler implements AppInterface {
    ...
    private static final /* synthetic */ int[] f13x72eb89a2 = null;
    /* renamed from: -com-android-internal-telephony-cat-ResultCodeSwitchesValues */
    private static final /* synthetic */ int[] f14-com-android-internal-telephony-cat-ResultCodeSwitchesValues = null;
    ...
    private int mSlotId;
    private boolean mStkAppInstalled = DBG;
    ...
    private static /* synthetic */ int[] -getcom-android-internal-telephony-cat-ResultCodeSwitchesValues() {
        if (f14-com-android-internal-telephony-cat-ResultCodeSwitchesValues != null) {
            return f14-com-android-internal-telephony-cat-ResultCodeSwitchesValues;
        }
        ...
        f14-com-android-internal-telephony-cat-ResultCodeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void handleCommand(CommandParams cmdParams, boolean isProactiveCmd) {
        ...
        switch (-getcom-android-internal-telephony-cat-AppInterface$CommandTypeSwitchesValues()[cmdParams.getCommandType().ordinal()]) {
            ...
            case 13:
                ...
                try {
                    noAlphaUsrCnf = this.mContext.getResources().getBoolean(17956999);
            ...
            case 6:
                if (((LaunchBrowserParams) cmdParams).mConfirmMsg.text != null && ((LaunchBrowserParams) cmdParams).mConfirmMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17040634);
            ...
            case 17:
                if (((DisplayTextParams) cmdParams).mTextMsg.text != null && ((DisplayTextParams) cmdParams).mTextMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17040633);
            ...
            case 18:
                if (((CallSetupParams) cmdParams).mConfirmMsg.text != null && ((CallSetupParams) cmdParams).mConfirmMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17040635);
            ...
            case 20:
                ...
                sendTerminalResponse(cmdParams.mCmdDet, resultCode, DBG, 0, null);
                break;
            case 21:
    ...
    private boolean removeMenu(Menu menu) {
        try {
            return (menu.items.size() == 1 && menu.items.get(0) == null) ? true : DBG;
    ...
    /* JADX WARNING: Missing block: B:13:0x0047, code skipped:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.HELP_INFO_REQUIRED) goto L_0x0050;
     */
    ...
    /* JADX WARNING: Missing block: B:20:0x0062, code skipped:
            if (r7.yesNo != false) goto L_0x0072;
     */
    ...
    /* JADX WARNING: Missing block: B:25:0x007e, code skipped:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.TERMINAL_CRNTLY_UNABLE_TO_PROCESS) goto L_0x0086;
     */
    ...
    /* JADX WARNING: Missing block: B:28:0x0086, code skipped:
            r12.mIncludeAdditionalInfo = DBG;
            r12.mAdditionalInfo = 0;
     */
    /* JADX WARNING: Missing block: B:30:0x008f, code skipped:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.LAUNCH_BROWSER_ERROR) goto L_0x0097;
     */
    ...
    /* JADX WARNING: Missing block: B:32:0x0095, code skipped:
            r5 = null;
     */
    /* JADX WARNING: Missing block: B:33:0x0097, code skipped:
            r12.mIncludeAdditionalInfo = DBG;
            r12.mAdditionalInfo = 0;
     */
    ...
    /* JADX WARNING: Missing block: B:37:0x00a9, code skipped:
            if (5 != r12.mEventValue) goto L_0x00b5;
     */
    /* JADX WARNING: Missing block: B:38:0x00ab, code skipped:
            eventDownload(r12.mEventValue, 2, 129, r12.mAddedInfo, DBG);
     */
    /* JADX WARNING: Missing block: B:39:0x00b4, code skipped:
            return;
     */
    /* JADX WARNING: Missing block: B:40:0x00b5, code skipped:
            eventDownload(r12.mEventValue, 130, 129, r12.mAddedInfo, DBG);
     */
    /* JADX WARNING: Missing block: B:52:0x00df, code skipped:
            r5 = null;
     */
