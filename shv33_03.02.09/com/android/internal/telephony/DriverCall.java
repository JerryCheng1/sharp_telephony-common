...
public class DriverCall implements Comparable<DriverCall> {
    ...
    public String toString() {
        ...
        if ("eng".equals(Build.TYPE)) {
            append = new StringBuilder().append("id=").append(this.index).append(",").append(this.state).append(",").append("toa=").append(this.TOA).append(",").append(this.isMpty ? "conf" : "norm").append(",").append(this.isMT ? "mt" : "mo").append(",").append(this.als).append(",");
            if (this.isVoice) {
                str = "voc";
            } else {
                str = "nonvoc";
            ...
            return append.append(str).append(",").append("number=").append(this.number).append(",cli=").append(this.numberPresentation).append(",").append("name=").append(this.name).append(",").append(this.namePresentation).toString();
        }
        append = new StringBuilder().append("id=").append(this.index).append(",").append(this.state).append(",").append("toa=").append(this.TOA).append(",").append(this.isMpty ? "conf" : "norm").append(",").append(this.isMT ? "mt" : "mo").append(",").append(this.als).append(",");
        if (this.isVoice) {
            str = "voc";
