...
public class RetryManager {
    ...
    private void configureRetry(boolean forDefault) {
        ...
        try {
            ...
            configString = forDefault ? b.getString("carrier_data_call_retry_config_default_string", DEFAULT_DATA_RETRY_CONFIG) : b.getString("carrier_data_call_retry_config_others_string", OTHERS_DATA_RETRY_CONFIG);
