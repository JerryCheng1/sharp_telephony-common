...
public interface CommandsInterface {
    ...
    void getAdnRecord(Message message);
    ...
    void getVoLTERoaming(Message message);
    ...
    void registerForAdnInitDone(Handler handler, int i, Object obj);

    void registerForAdnRecordsInfo(Handler handler, int i, Object obj);
    ...
    void setVoLTERoaming(int i, Message message);
    ...
    void unregisterForAdnInitDone(Handler handler);

    void unregisterForAdnRecordsInfo(Handler handler);
    ...
    void updateAdnRecord(SimPhoneBookAdnRecord simPhoneBookAdnRecord, Message message);
