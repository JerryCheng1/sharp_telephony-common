...
public final class SmsApplication {
        ...
        for (ResolveInfo resolveInfo : smsReceivers) {
            ...
            if (activityInfo != null && "android.permission.BROADCAST_SMS".equals(activityInfo.permission)) {
                ...
                if (!receivers.containsKey(packageName)) {
                    SmsApplicationData smsApplicationData2 = new SmsApplicationData(resolveInfo.loadLabel(packageManager).toString(), packageName, activityInfo.applicationInfo.uid);
    ...
    private static SmsApplicationData getApplication(Context context, boolean updateIfNeeded, int userId) {
        ...
        if (updateIfNeeded && applicationData == null) {
            applicationData = getApplicationForPackage(applications, context.getResources().getString(17039437));
        ...
        if (applicationData != null) {
            ...
            if (updateIfNeeded) {
                ...
                assignWriteSmsPermissionToSystemApp(context, packageManager, appOps, SMS_BACKUP_PACKAGE_NAME);
    ...
    public static boolean isDefaultSmsApplication(Context context, String packageName) {
        ...
        if ((defaultSmsPackage != null && defaultSmsPackage.equals(packageName)) || BLUETOOTH_PACKAGE_NAME.equals(packageName) || SMS_BACKUP_PACKAGE_NAME.equals(packageName)) {
            return true;
        }
        return DEBUG_MULTIUSER;
    }
