...
public class CallManager {
    ...
    public boolean registerPhone(Phone phone) {
        if ((TelBrand.IS_SBM || TelBrand.IS_KDDI) && (phone instanceof SipPhone)) {
            unregisterPhone(phone);
        }
    ...
    public Connection dial(Phone phone, String dialString, int videoState, int prefix) throws CallStateException {
        ...
        if (canDial(phone)) {
            ...
            if (TelBrand.IS_DCM) {
                result = phone.dial(dialString, videoState, prefix);
            } else {
    ...
    public Connection dial(Phone phone, String dialString, UUSInfo uusInfo, int videoState, int prefix) throws CallStateException {
        if (TelBrand.IS_DCM) {
            return phone.dial(dialString, uusInfo, videoState, null, prefix);
        }
