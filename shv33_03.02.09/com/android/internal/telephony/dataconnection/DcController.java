                        ...
                        if (newState.active != 0) {
                            ...
                            if (TelBrand.IS_KDDI) {
                                ...
                                for (ApnContext apnContext2 : dc2.mApnContexts.keySet()) {
                                    if (apnContext2.getState() == DctConstants.State.CONNECTED || apnContext2.getState() == DctConstants.State.CONNECTING) {
                                        connectedApns.add(apnContext2);
                                    }
                                }
                                for (ApnContext apnc : connectedApns) {
                                    DcController.this.mDct.sendOemKddiFailCauseBroadcast(DcFailCause.fromInt(newState.status), apnc);
                                }
                            }
                        }
                    }
