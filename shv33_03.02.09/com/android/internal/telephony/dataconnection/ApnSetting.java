...
public class ApnSetting {
    ...
    public boolean canHandleType(String type) {
        ...
        if (TelBrand.IS_DCM && type.equals("ims")) {
            ...
            for (String t2 : this.types) {
                if (t2.equalsIgnoreCase(type) || t2.equalsIgnoreCase(CharacterSets.MIMENAME_ANY_CHARSET) || (t2.equalsIgnoreCase("default") && type.equalsIgnoreCase("hipri"))) {
                    return true;
                }
            }
        }
    ...
    /* JADX WARNING: Missing block: B:47:0x00b9, code skipped:
            return DBG;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
