...
public class TelephonyNetworkFactory extends NetworkFactory {
    ...
    private void onActivePhoneSwitch() {
        ...
        if (this.mIsActive != newIsActive) {
            ...
            log(logString);
            if (this.mIsDefault) {
                applyRequests(this.mDefaultRequests, this.mIsActive ? true : RELEASE, logString);
            }
            HashMap hashMap = this.mSpecificRequests;
            if (!this.mIsActive) {
                z = RELEASE;
            }
    ...
    private void onDefaultChange() {
        boolean newIsDefault = this.mSubscriptionController.getDefaultDataSubId() == this.mSubscriptionId ? true : RELEASE;
