...
public class DataConnection extends StateMachine {
    ...
    private class DcActivatingState extends State {
        ...
        private static final /* synthetic */ int[] f17x5f2cdfda = null;
                ...
                case DataConnection.EVENT_SETUP_DATA_CONNECTION_DONE /*262145*/:
                    ...
                    switch (-getcom-android-internal-telephony-dataconnection-DataCallResponse$SetupResultSwitchesValues()[result.ordinal()]) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            if (TelBrand.IS_KDDI && (cp.mOnCompletedMsg.obj instanceof Pair)) {
                                apnContext = cp.mOnCompletedMsg.obj.first;
                                if (apnContext != null) {
                                    DataConnection.this.mDct.sendOemKddiFailCauseBroadcast(result.mFailCause, apnContext);
                                }
                            }
                ...
                case DataConnection.EVENT_GET_LAST_FAIL_DONE /*262146*/:
                    ...
                    if (cp.mTag == DataConnection.this.mTag) {
                        ...
                        if (ar.exception == null) {
                            ...
                            if (TelBrand.IS_KDDI && (cp.mOnCompletedMsg.obj instanceof Pair)) {
                                apnContext = (ApnContext) ((Pair) cp.mOnCompletedMsg.obj).first;
                                if (apnContext != null) {
                                    DataConnection.this.mDct.sendOemKddiFailCauseBroadcast(cause, apnContext);
                                }
                            }
    ...
    private class DcActiveState extends State {
        ...
        public void enter() {
            ...
            if (DataConnection.this.hasMessages(DataConnection.EVENT_DISCONNECT, DataConnection.this.mConnectionParams.mOnCompletedMsg.obj) || DataConnection.this.hasMessages(DataConnection.EVENT_DISCONNECT_ALL, DataConnection.this.mConnectionParams.mOnCompletedMsg.obj) || DataConnection.this.hasDeferredMessages(DataConnection.EVENT_DISCONNECT, DataConnection.this.mConnectionParams.mOnCompletedMsg.obj) || DataConnection.this.hasDeferredMessages(DataConnection.EVENT_DISCONNECT_ALL, DataConnection.this.mConnectionParams.mOnCompletedMsg.obj)) {
            ...
            switch (msg.what) {
                ...
                case DataConnection.EVENT_DISCONNECT /*262148*/:
                    ...
                    if (DataConnection.this.mApnContexts.containsKey(dp.mApnContext)) {
                        ...
                        if (dp.mOnCompletedMsg != null) {
                            dp.mApnContext.setReason(dp.mReason);
                        }
                ...
                case DataConnection.EVENT_DISCONNECT_ALL /*262150*/:
                    ...
                    if (!(dp == null || dp.mOnCompletedMsg == null)) {
                        Message disconnectCompleteMsg = dp.mOnCompletedMsg;
                        if (disconnectCompleteMsg.obj instanceof ApnContext) {
                            disconnectCompleteMsg.obj.setReason(dp.mReason);
                        }
                    }
                    DataConnection.this.mDisconnectParams = dp;
                    DataConnection.this.mConnectionParams = null;
    ...
    public UpdateLinkPropertyResult updateLinkProperty(DataCallResponse newState) {
        ...
        if (TelBrand.IS_KDDI) {
            ...
            if (this.mApnSetting.oemDnses != null) {
                ...
                for (String addr2 : this.mApnSetting.oemDnses) {
                    if (addr2 != null) {
                        addr2 = addr2.trim();
                        if (!addr2.isEmpty()) {
                            dnses.add(addr2);
                ...
                if (newState.dnses != null) {
                    for (String addr22 : newState.dnses) {
                        if (addr22 != null && !addr22.trim().isEmpty()) {
            ...
            if (this.mPhone.mDcTracker.mEnableApnCarNavi) {
                ...
                if (newState.addresses != null && newState.addresses.length > 0) {
                    for (String addr222 : newState.addresses) {
                        addr222 = addr222.trim();
                        if (!addr222.isEmpty()) {
                            String[] ap = addr222.split("/");
                            if (ap.length == 2) {
    ...
    private void checkSetMtu(ApnSetting apn, LinkProperties lp) {
        if (lp != null && apn != null && lp != null) {
            if (lp.getMtu() != 0) {
                ...
                int mtu = this.mPhone.getContext().getResources().getInteger(17694858);
                if (mtu != 0) {
                    lp.setMtu(mtu);
                    if (DBG) {
