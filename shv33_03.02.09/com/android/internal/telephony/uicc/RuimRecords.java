...
public class RuimRecords extends IccRecords {
                    ...
                    if (checkLengthLegal(mipUppLength, 4)) {
                        ...
                        while (index < numNai && checkLengthLegal(mipUppLength, 4)) {
                            ...
                            if (checkLengthLegal(mipUppLength, 8)) {
                                ...
                                if (checkLengthLegal(mipUppLength, (naiLength << 3) + CallFailCause.RECOVERY_ON_TIMER_EXPIRED)) {
                                    bitStream.skip((naiLength << 3) + CallFailCause.MESSAGE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE);
                                    mipUppLength -= (naiLength << 3) + CallFailCause.RECOVERY_ON_TIMER_EXPIRED;
                                    if (bitStream.read(1) == 1) {
    ...
    private String decodeImsi(byte[] data) {
        ...
        int digits_11_12 = decodeImsiDigits(data[6] & CallFailCause.INTERWORKING_UNSPECIFIED, 2);
