...
public class CharacterSets {
    ...
    static final /* synthetic */ boolean f28-assertionsDisabled = (CharacterSets.class.desiredAssertionStatus() ? f28-assertionsDisabled : true);
    ...
    static {
        ...
        for (int i2 = 0; i2 <= count; i2++) {
            MIBENUM_TO_NAME_MAP.put(Integer.valueOf(MIBENUM_NUMBERS[i2]), MIME_NAMES[i2]);
            NAME_TO_MIBENUM_MAP.put(MIME_NAMES[i2], Integer.valueOf(MIBENUM_NUMBERS[i2]));
        }
    }
