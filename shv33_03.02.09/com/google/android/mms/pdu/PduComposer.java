...
public class PduComposer {
    ...
    static final /* synthetic */ boolean f29-assertionsDisabled;
    ...
    private static class LengthRecordNode {
        ...
        /* synthetic */ LengthRecordNode(LengthRecordNode lengthRecordNode) {
            this();
        }
    ...
    static {
        ...
        if (PduComposer.class.desiredAssertionStatus()) {
            z = f29-assertionsDisabled;
        } else {
            z = true;
        }
        f29-assertionsDisabled = z;
    ...
    private int makeSendRetrievePdu(int type) {
        ...
        boolean recipient = f29-assertionsDisabled;
