...
public interface IPortableSimAppService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPortableSimAppService {
        ...
        public static IPortableSimAppService asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPortableSimAppService)) ? new Proxy(iBinder) : (IPortableSimAppService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    int connetionState = getConnetionState();
                    parcel2.writeNoException();
                    parcel2.writeInt(connetionState);
                    return true;
                case 1598968902:
