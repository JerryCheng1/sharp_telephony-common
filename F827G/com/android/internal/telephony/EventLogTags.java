...
public class EventLogTags {
    ...
    public static void writeCallDrop(int i, int i2, int i3) {
        EventLog.writeEvent(CALL_DROP, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }

    public static void writeCdmaDataDrop(int i, int i2) {
        EventLog.writeEvent(CDMA_DATA_DROP, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
    }

    public static void writeCdmaDataSetupFailed(int i, int i2, int i3) {
        EventLog.writeEvent(CDMA_DATA_SETUP_FAILED, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }

    public static void writeCdmaDataStateChange(String str, String str2) {
        EventLog.writeEvent(CDMA_DATA_STATE_CHANGE, new Object[]{str, str2});
    }

    public static void writeCdmaServiceStateChange(int i, int i2, int i3, int i4) {
        EventLog.writeEvent(CDMA_SERVICE_STATE_CHANGE, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)});
    }

    public static void writeDataNetworkRegistrationFail(int i, int i2) {
        EventLog.writeEvent(DATA_NETWORK_REGISTRATION_FAIL, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
    }

    public static void writeDataNetworkStatusOnRadioOff(String str, int i) {
        EventLog.writeEvent(DATA_NETWORK_STATUS_ON_RADIO_OFF, new Object[]{str, Integer.valueOf(i)});
    }
    ...
    public static void writeGsmDataStateChange(String str, String str2) {
        EventLog.writeEvent(GSM_DATA_STATE_CHANGE, new Object[]{str, str2});
    }

    public static void writeGsmRatSwitched(int i, int i2, int i3) {
        EventLog.writeEvent(GSM_RAT_SWITCHED, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }

    public static void writeGsmRatSwitchedNew(int i, int i2, int i3) {
        EventLog.writeEvent(GSM_RAT_SWITCHED_NEW, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }

    public static void writeGsmServiceStateChange(int i, int i2, int i3, int i4) {
        EventLog.writeEvent(GSM_SERVICE_STATE_CHANGE, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)});
    }
    ...
    public static void writePdpNetworkDrop(int i, int i2) {
        EventLog.writeEvent(PDP_NETWORK_DROP, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
    }
    ...
    public static void writePdpSetupFail(int i, int i2, int i3) {
        EventLog.writeEvent(PDP_SETUP_FAIL, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }
}
